            ...
            const defineScales = () => {
                ...
                const defineReservedSpaceInCategoricalAxes = () =>{
                    const calculateCategoricalAxesSizes = () => {
                        ...
                        this.axesPadding = 100;
                        this.axesSizes = {};
                        this.categoricalKeys.forEach( key => {
                            let sizeWithNoPadding = this.y[key](this.domain[key][0]) - this.y[key](this.domain[key][1]);
                            this.axesSizes[key] = sizeWithNoPadding - sizeWithNoPadding/(this.axesPadding*2/100);
                        })
                    };
        ...
        this.axis = this.overlay.selectAll(".axis")
            ...
            .each(function(d) {
                if(self.domainType[d] !== 'Categorical') d3.select(this).call(axis.scale(y_axes[d]));
                    ...
                    //TODO: change padding hardcoded variable to a configurable parameter in this.axesPadding
